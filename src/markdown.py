...
def compile_italic_underscore(line):
    ...
    '<i>a</i> and <i>b</i>'
    >>> compile_italic_underscore('_a_ and _b') #odd is literal
    '<i>a</i> and _b'
...
def compile_links(line):
    ...
    These delimiters are not symmetric, however, so we can more
    easily find the start and stop locations using the strings find
    function.

    >>> compile_links('Click on the [course webpage](http://x.co)!')
    'Click on the <a href="http://x.co">course webpage</a>!'
    >>> compile_links('[course webpage](http://x.co)')
    '<a href="http://x.co">course webpage</a>'
    >>> compile_links('this is wrong: [course webpage]    (http://x.co)')
    'this is wrong: [course webpage]    (http://x.co)'
    >>> compile_links('this is wrong: [course webpage](http://x.co')
    'this is wrong: [course webpage](http://x.co'
